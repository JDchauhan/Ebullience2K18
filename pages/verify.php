...
<body>
    ...
    <div id="timer" class="timer">
      ...
      <form action="verify-otp.php">
          <input type="text" name="otp" placeholder="Enter OTP" class="txt-sml" style="margin-top: 10px;"><br>  
          <input type="submit" name="submit" placeholder="Verify" value="Verify" class="btn-sml">      
      </form>
